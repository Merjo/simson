...
def calc_tramp_econ_model_one_year(q_st, q_eol_g, t_eol_g, p_0_st, p_st, r_0_recov_g, ip_tlrc_i, s_cu_alloy_g):
...
def _test():
    q_st = np.random.rand(12, 5) * 40000 + 40000
    q_eol_g = np.random.rand(12, 4, 5) * 5000 + 5000
    t_eol_g = np.random.rand(12, 4, 5) * 4000 - 2000
    ...
    q_pr_st, q_se_st, r_recov_g, s_cu_g = \
        calc_tramp_econ_model_one_year(q_st, q_eol_g, t_eol_g, p_0_st, p_st, r_0_recov_g, ip_tlrc_i, s_cu_alloy_g)
